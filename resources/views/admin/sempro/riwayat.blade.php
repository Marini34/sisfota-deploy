<x-app-layout>
    @section('title', 'Riwayat Seminar Proposal')
    @section('head')
    ...
    <x-main-card>
        ...
        <div class="text-gray-900 dark:text-gray-100">
                ...
                <table id="myTable" class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        @foreach ($seminarSidangs as $sempro)
                            ...
                            <dialog id="confirmDialog_{{ $sempro->slug }}"
                                ...
                                <div class="relative">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <form action="{{ route('batal.sempro', $sempro->slug) }}" method="POST"
                            ...
                            <tr>
                                <td class="">{{ $sempro->tanggal_pelaksanaan }}</td>
                                ...
                                <td class="text-center">
                                    @if ($sempro->status_pendaftaran === 'Diterima')
                                        ...
                                        @elseif ($sempro->status_pendaftaran === 'Dibatalkan')
                                            <div
                                                class="p-2 w-auto text-sm text-red-600 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800">
                                            @else
                                                <div
            ...
            <td class="whitespace-nowrap text-center">
                <a href="/admin/sempro/detail/{{ $sempro->slug }}" data-tooltip-target="detail_{{ $sempro->slug }}"
                ...
                @if ($sempro->status_kelulusan === 'Menunggu Keputusan')
                    <button data-tooltip-target="batal_{{ $sempro->slug }}" data-tooltip-placement="bottom"
