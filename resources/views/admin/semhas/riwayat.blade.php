<x-app-layout>
    @section('title', 'Riwayat Seminar Hasil')
    @section('head')
    ...
    <x-main-card>
        ...
        <div class="text-gray-900 dark:text-gray-100">
                ...
                <table id="myTable" class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        @foreach ($seminarSidangs as $semhas)
                                ...
                                <div class="relative">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                            Apakah kamu yakin untuk membatalkan verifikasi pendaftaran ini?
                                        </h3>
                                        <form action="{{ route('batal.semhas', $semhas->slug) }}" method="POST"
                            ...
                            <tr>
                                <td class="">{{ $semhas->tanggal_pelaksanaan }}</td>
                                <td class="">{{ $semhas->mahasiswa->nama_lengkap }}</td>
                                <td class="">{{ $semhas->mahasiswa->nim }}</td>
                                <td class="">{{ $semhas->tugas_akhir->judul }}</td>
            ...
            <td class="whitespace-nowrap text-center">
                <a href="/admin/semhas/detail/{{ $semhas->slug }}" data-tooltip-target="detail_{{ $semhas->slug }}"
                ...
                @if ($semhas->status_kelulusan === 'Menunggu Keputusan')
                    <button data-tooltip-target="batal_{{ $semhas->slug }}" data-tooltip-placement="bottom"
                        type="button" onclick="showConfirm('{{ $semhas->slug }}')"
        ...
        <script type="text/javascript">
            let table = new DataTable('#myTable', {
                ...
                language: {
                    ...
                    emptyTable: "Belum ada data yang bisa ditampilkan"
                },
                columnDefs: [{
                        targets: [-1],
                        width: "10%",
