<x-app-layout>
    @section('title', 'Berita Acara Seminar Hasil')
    @section('head')
                        ...
                        @foreach ($seminarSidangs as $semhas)
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="p-2 w-auto text-sm text-green-500 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800">
                                        <span class="font-medium">{{ $semhas->status_kelulusan }}</span>
                                    </div>
                                </td>
                                <td class="whitespace-nowrap text-center">
                                    <a href="/admin/semhas/berita-acara/{{ $semhas->slug }}"
