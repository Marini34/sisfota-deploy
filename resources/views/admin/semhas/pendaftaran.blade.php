<x-app-layout>
    @section('title', 'Kelola Pendaftaran Seminar Hasil')
    @section('head')
        ...
        <div class="text-gray-900 dark:text-gray-100">
            <div class="flex items-center justify-between mb-4">
                <h5 class="mb-2 text-2xl font-medium tracking-tight text-gray-900 dark:text-white">
                    Kelola Pendaftaran Seminar Hasil
                </h5>
            </div>
                    ...
                    <tbody>
                        @foreach ($seminarSidangs as $semhas)
                            <tr>
                                ...
                                {{-- @php
                                    dd($semhas->tugas_akhir);
                                @endphp --}}
                                <td class="">{{ $semhas->tugas_akhir->judul }}</td>
                                <td class="">
                                    1. {{ $semhas->tugas_akhir->dosen_pembimbing_1->nama_dosen }} <br>
                                    2. {{ $semhas->tugas_akhir->dosen_pembimbing_2->nama_dosen }}
                                </td>
                                <td class="whitespace-nowrap text-center">
                                    <a href="/admin/semhas/detail/{{ $semhas->slug }}"
        ...
        <script type="text/javascript">
            let table = new DataTable('#myTable', {
                ...
                language: {
                    ...
                    emptyTable: "Belum ada pendaftaran seminar hasil yang masuk"
                },
                columnDefs: [{
                        targets: [-1],
                        width: "5%",
