<x-app-layout>
    @section('title', 'Riwayat Sidang Akhir')
    @section('head')
    ...
    <x-main-card>
        ...
        <div class="text-gray-900 dark:text-gray-100">
                            ...
                            <dialog id="confirmDialog_{{ $sidang->slug }}"
                                ...
                                <div class="relative">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <form action="{{ route('batal.sidang', $sidang->slug) }}" method="POST"
            ...
            <td class="whitespace-nowrap text-center">
                <a href="/admin/sidang/detail/{{ $sidang->slug }}" data-tooltip-target="detail_{{ $sidang->slug }}"
                ...
                @if ($sidang->status_kelulusan === 'Menunggu Keputusan')
                    <button data-tooltip-target="batal_{{ $sidang->slug }}" data-tooltip-placement="bottom"
                        type="button" onclick="showConfirm('{{ $sidang->slug }}')"
        ...
        <script type="text/javascript">
            let table = new DataTable('#myTable', {
                ...
                language: {
                    ...
                    emptyTable: "Belum ada data yang dapat ditampilkan..."
                },
                columnDefs: [{
                        targets: [-1],
                        width: "10%",
