<x-app-layout>
    ...
    <x-main-card>
        <div>
            <form action="{{route('edit.passing.grade.semhas')}}" method="post">
                @csrf
                <label for="passingGrade" class="font-bold text-lg">Nilai Standar Kelulusan Semhas :</label>
        ...
        <dialog id="modalForm" class="miniscrollbar bg-white rounded-lg shadow-2xl w-11/12 sm:w-3/5 fixed">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white uppercase">
                    Tambah Parameter Penilaian Semhas
                </h3>
            ...
            <!-- Modal body -->
            <form action="{{ route('store.parameter.semhas') }}" method="post" class="p-4 md:p-5">
                @csrf
        ...
        <div class="text-gray-900 dark:text-gray-100">
            <div class="flex items-center justify-between mb-4">
                <h5 class="mb-2 text-2xl font-medium tracking-tight text-gray-900 dark:text-white">
                    Kelola Parameter Penilaian Semhas
                </h5>
                            ...
                            @foreach ($parameters as $index => $parameter)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/kaprodi/parameter-semhas/edit/{{ $parameter->id }}"
