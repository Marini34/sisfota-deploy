<x-app-layout>
    ...
    <x-main-card>
        ...
        @endif
        <form action="{{ route('edit.parameter.sempro', $parameter->id) }}" method="post">
            @csrf
            ...
            <div class="border border-slate-300 rounded-md">
                ...
                <trix-editor input="editDeskripsi" class="trix-editor" placeholder="Masukkan deskripsi parameter...">
                    @php
