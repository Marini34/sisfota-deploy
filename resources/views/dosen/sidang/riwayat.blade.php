<x-app-layout>
    @section('title', 'Riwayat Penilaian Sidang Akhir')
    @section('head')
        ...
        <div class="text-gray-900 dark:text-gray-100">
            <div class="flex items-center justify-between mb-4">
                <h5 class="mb-2 text-2xl font-medium tracking-tight text-gray-900 dark:text-white">
                    Riwayat Penilaian Sidang Akhir
                </h5>
            </div>
                ...
                <table id="myTable" class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        @foreach ($seminarSidangs as $sidang)
                            ...
                            <dialog id="confirmDialog_{{ $sidang->slug }}"
                                ...
                                <div class="relative">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <form action="{{ route('dosen.sidang.penilaian.batal', $sidang->slug) }}"
                            ...
                            <tr>
                                <td class="min-w-32">{{ $sidang->mahasiswa->nama_lengkap }}</td>
                                <td class="">{{ $sidang->mahasiswa->nim }}</td>
                                <td class="min-w-40">{{ $sidang->tugas_akhir->judul }}</td>
                                <td class="">
                                    {{ \Carbon\Carbon::parse($sidang->tanggal_pelaksanaan)->translatedFormat('l, d F Y') }}
                                </td>
                                ...
                                <td class="whitespace-nowrap text-center">
                                    ...
                                    <a href="/dosen/penilaian-sidang/edit/{{ $sidang->slug }}"
                                    ...
                                    <button data-tooltip-target="batal_{{ $sidang->slug }}"
                                        data-tooltip-placement="bottom" type="button"
                                    ...
                                    <div id="batal_{{ $sidang->slug }}" role="tooltip"
                                        class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                        Batalkan
                                        <div class="tooltip-arrow" data-popper-arrow></div>
                                    </div>
