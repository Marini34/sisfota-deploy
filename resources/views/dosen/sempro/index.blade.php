                ...
                <table id="myTable" class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        @foreach ($seminarSidangs as $sempro)
                            @php
                                $tanggalPelaksanaan = \Carbon\Carbon::parse($sempro->tanggal_pelaksanaan);
                            ...
                            <tr>
                                ...
                                <td class="">{{ \Carbon\Carbon::parse($sempro->tanggal_pelaksanaan)->translatedFormat('l, d F Y') }}</td>
                                ...
                                <td class="whitespace-nowrap text-center">
                                    ...
                                    <a  href="/dosen/penilaian-sempro/nilai/{{ $sempro->slug }}"
                                    ...
                                    <button data-tooltip-target="nilai_{{ $sempro->slug }}"
                                        data-tooltip-placement="bottom" type="button"
        ...
        <script type="text/javascript">
            let table = new DataTable('#myTable', {
                ...
                language: {
                    ...
                    emptyTable: "Belum ada seminar proposal yang perlu dinilai"
                },
                columnDefs: [{
                        targets: [-1],
                        width: "5%",
