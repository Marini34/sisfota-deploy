                ...
                <table id="myTable" class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        @foreach ($seminarSidangs as $semhas)
                            @php
                                $tanggalPelaksanaan = \Carbon\Carbon::parse($semhas->tanggal_pelaksanaan);
                            ...
                            <tr>
                                ...
                                <td class="">{{ \Carbon\Carbon::parse($semhas->tanggal_pelaksanaan)->translatedFormat('l, d F Y') }}</td>
                                ...
                                <td class="whitespace-nowrap text-center">
                                    <a href="/dosen/penilaian-semhas/detail/{{ $semhas->slug }}"
                                        data-tooltip-target="detail_{{ $semhas->slug }}" data-tooltip-placement="bottom"
                                        type="button"
                                    ...
                                    <a  href="/dosen/penilaian-semhas/nilai/{{ $semhas->slug }}"
                                    ...
                                    <button data-tooltip-target="nilai_{{ $semhas->slug }}"
                                        data-tooltip-placement="bottom" type="button"
        ...
        <script type="text/javascript">
            let table = new DataTable('#myTable', {
                ...
                language: {
                    ...
                    emptyTable: "Belum ada seminar hasil yang perlu dinilai"
                },
                columnDefs: [{
                        targets: [-1],
                        width: "5%",
