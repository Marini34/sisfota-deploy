<x-app-layout>
    @section('title', 'Hasil Seminar Proposal')
    <x-main-card>
        <div class="overflow-x-auto miniscrollbar">
            <table class="table table-striped table-hover" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>{{ $sempro->total_nilai_akhir }}</td>
                </tr>
                <tr>
                    <th>Keterangan</th>
                    <td class="font-bold">:</td>
                ...
                <tr>
                    ...
                    <td>
                        @php
                            $formattedText = $sempro->catatan_ta_pembimbing_1;
                ...
                <tr>
                    ...
                    <td>
                        @php
                            $formattedText = $sempro->catatan_ta_pembimbing_2;
                            if (strpos($formattedText, '<ol>') !== false) {
                                $formattedText = str_replace('<ol>', '<ol class="list-decimal pl-7">', $formattedText);
                            }
                            if (strpos($formattedText, '<ul>') !== false) {
                ...
                <tr>
                    ...
                    <td>
                        @php
                            $formattedText = $sempro->catatan_ta_penguji_1;
                            if (strpos($formattedText, '<ol>') !== false) {
                                $formattedText = str_replace('<ol>', '<ol class="list-decimal pl-7">', $formattedText);
                            }
                            if (strpos($formattedText, '<ul>') !== false) {
                ...
                <tr>
                    ...
                    <td>
                        @php
                            $formattedText = $sempro->catatan_ta_penguji_2;
                            if (strpos($formattedText, '<ol>') !== false) {
                                $formattedText = str_replace('<ol>', '<ol class="list-decimal pl-7">', $formattedText);
                            }
                            if (strpos($formattedText, '<ul>') !== false) {
                ...
                <tr>
                    ...
                    <td class="font-bold">:</td>
                    <td><a href="#">{{ $sempro->file_notulensi }}</a></td>
                </tr>
                <tr>
                    ...
                    <td>
                        @php
                            $catatan = json_decode($sempro->catatan_ta_notulen_mahasiswa_id, true) ?? [];
