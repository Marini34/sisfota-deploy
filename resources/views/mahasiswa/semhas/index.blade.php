<x-app-layout>
    @section('title', 'Pendaftaran Seminar Hasil')
    @section('head')
    ...
    <x-main-card>
        ...
        @if (
            ...
            <dialog id="modalForm" class="miniscrollbar bg-white rounded-lg shadow-2xl w-11/12 sm:w-3/5 lg:w-2/5">
                ...
                <!-- Modal body -->
                <form action="{{ route('store.semhas') }}" method="post" enctype="multipart/form-data"
                    class="p-4 md:p-5">
                    @csrf
                    ...
                    <div class="my-2">
                        <label for="dokumenSemhas"><span>File Dokumen Seminar Hasil</span></label>
                        <input required id="dokumenSemhas" name="dokumenSemhas" type="file"
                    ...
                    <div class="my-2">
                        <label for="accJadwal"><span>Surat ACC Jadwal Seminar</span></label>
            ...
            <div class="text-gray-900 dark:text-gray-100">
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped table-hover">
                        ...
                        <tbody>
                            @foreach ($seminarSidangs as $index => $semhas)
                                {{-- Confirmation Delete Modal --}}
                                <dialog id="confirmDialog_{{ $semhas->slug }}"
                                    class="fixed p-2 rounded-lg shadow-2xl w-full max-w-md max-h-full">
                                    <div class="relative">
                                        <button onclick="closeConfirmDialog('{{ $semhas->slug }}')" type="button"
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <form action="{{ route('semhas.delete', $semhas->slug) }}" method="POST"
                                            ...
                                            <button onclick="closeConfirmDialog('{{ $semhas->slug }}')"
                                                type="button"
                                ...
                                {{-- <div class="modal-content">
                                    <dialog id="modalRevisi_{{ $semhas->slug }}"
                                        class="miniscrollbar bg-white rounded-lg shadow-2xl w-11/12 sm:w-3/5 lg:w-2/5">
                                        <div
                                            class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white uppercase">
                                                File Revisi Seminar Hasil
                                            </h3>
                                            <button onclick="closeDialogRevisi('{{ $semhas->slug }}')" type="button"
                                                class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm h-8 w-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                data-modal-toggle="timeline-modal">
                                                <svg class="w-3 h-3" aria-hidden="true"
                                                    xmlns="http://www.w3.org/2000/svg" fill="none"
                                        ...
                                        @if ($semhas->status_pendaftaran === 'Diterima' && $semhas->file_revisi != null)
                                            <form action="{{ route('ubah.revisi.semhas', $semhas->slug) }}"
                                        ...
                                        @else
                                            <form action="{{ route('store.revisi.semhas', $semhas->slug) }}"
                                                method="post" enctype="multipart/form-data" class="p-2">
                                                @csrf
                                                <div class="mx-5 mb-3">
                                                    <div class="my-2">
                                ...
                                <dialog id="modalDitolak_{{ $semhas->slug }}"
                                    class="miniscrollbar bg-white rounded-lg shadow-2xl w-11/12 sm:w-3/5 lg:w-2/5">
                                    <div
                                        ...
                                        <button onclick="closeDialogAlasan('{{ $semhas->slug }}')" type="button"
                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm h-8 w-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            data-modal-toggle="timeline-modal">
                                    ...
                                    <div class="flex items-start gap-2.5 px-5 border-gray-200 bg-red-100">
                                        <div class="flex flex-col w-full leading-1.5 p-4">
                                            <div class="py-2.5 text-gray-900">
                                                @php
                                                    $alasan_penolakan = $semhas->alasan_penolakan;
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($semhas->status_pendaftaran === 'Menunggu Verifikasi')
                                            ...
                                            @elseif ($semhas->status_pendaftaran === 'Diterima')
                                                <div
                                                ...
                                                @elseif ($semhas->status_pendaftaran === 'Ditolak')
                                                    <div
                                        ...
                                        <div>
                                            @if ($semhas->status_kelulusan === 'LULUS' || $semhas->status_kelulusan === 'TIDAK LULUS')
                                                <span class="font-medium">{{ $semhas->status_pendaftaran }}
                                                    ({{ $semhas->status_kelulusan }})
                                                </span>
                                            @else
                                                <span class="font-medium">{{ $semhas->status_pendaftaran }}</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="whitespace-nowrap text-center">
                                        <a href="/mahasiswa/semhas/detail/{{ $semhas->slug }}"
                                            data-tooltip-target="detail_{{ $semhas->slug }}"
                                        ...
                                        <div id="detail_{{ $semhas->slug }}" role="tooltip"
                                            class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                            Detail
                                            <div class="tooltip-arrow" data-popper-arrow></div>
                                        </div>
                                        @if ($semhas->status_pendaftaran === 'Menunggu Verifikasi')
                                            <a href="/mahasiswa/semhas/ubah/{{ $semhas->slug }}"
                                                data-tooltip-target="ubah_{{ $semhas->slug }}"
                                                data-tooltip-placement="bottom" type="button"
                                            ...
                                            <div id="ubah_{{ $semhas->slug }}" role="tooltip"
                                                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                Ubah
                                                <div class="tooltip-arrow" data-popper-arrow></div>
                                            </div>

                                            <button data-tooltip-target="hapus_{{ $semhas->slug }}"
                                                data-tooltip-placement="bottom" type="button"
                                                onclick="showConfirm('{{ $semhas->slug }}')"
                                            ...
                                            <div id="hapus_{{ $semhas->slug }}" role="tooltip"
                                                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                Hapus
                                                <div class="tooltip-arrow" data-popper-arrow></div>
                                            </div>
                                        @elseif ($semhas->status_pendaftaran === 'Ditolak')
                                            <button data-tooltip-target="ditolak_{{ $semhas->slug }}"
                                                data-tooltip-placement="bottom" type="button"
                                                onclick="showModalAlasan('{{ $semhas->slug }}')"
                                                class="cursor-pointer text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm w-8 h-7 inline-flex items-center justify-center">
                                                <i class="bi bi-question-circle"></i>
                                            </button>

                                            <div id="ditolak_{{ $semhas->slug }}" role="tooltip"
                                                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                Alasan Ditolak
                                                <div class="tooltip-arrow" data-popper-arrow></div>
                                            </div>
                                        @elseif ($semhas->status_kelulusan === 'LULUS' || $semhas->status_kelulusan === 'TIDAK LULUS')
                                            <a href="/mahasiswa/semhas/hasil/{{ $semhas->slug }}"
                                                data-tooltip-target="hasil_{{ $semhas->slug }}"
                                                data-tooltip-placement="bottom" type="button"
                                                class="cursor-pointer text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm w-8 h-7 inline-flex items-center justify-center">
                                                <i class="bi bi-envelope-check"></i>
                                            </a>

                                            <div id="hasil_{{ $semhas->slug }}" role="tooltip"
                                                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                Hasil Semhas
                                                <div class="tooltip-arrow" data-popper-arrow></div>
                                            </div>
                                            ...
                                            {{-- @if ($semhas->status_pendaftaran === 'Diterima' && $semhas->file_revisi != null)
                                                <button data-tooltip-target="revisi_{{ $semhas->slug }}"
                                                    data-tooltip-placement="bottom" type="button"
                                                    onclick="showModalRevisi('{{ $semhas->slug }}')"
                                                ...
                                                <div id="revisi_{{ $semhas->slug }}" role="tooltip"
                                                    class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                    Ubah File Revisi Semhas
                                                    <div class="tooltip-arrow" data-popper-arrow></div>
                                                </div>
                                            @else
                                                <button data-tooltip-target="revisi_{{ $semhas->slug }}"
        ...
        @elseif (
            ...
            <div id="alert-additional-content-1"
                ...
                <div class="mt-2 mb-4 text-sm">
                    Untuk dapat melakukan pendaftaran Seminar Hasil, kamu perlu melakukan rekam bimbingan tugas akhir
        ...
        @else
            <div id="alert-additional-content-1"
                ...
                <div class="mt-2 mb-4 text-sm">
                    Untuk dapat melakukan pendaftaran Seminar Hasil, kamu perlu menyelesaikan Seminar Proposal yang
                    terakhir kamu daftarkan terlebih
                    dahulu.
                </div>
